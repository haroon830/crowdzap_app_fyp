...
class AdminSelectedItemDetailDialog extends Component {
    constructor(props){
        super(props)
        this.state ={
                ...
                >
                    <Paper style={{backgroundColor:"#0EAAA6"}}>
                        ...
                        >
                            ...
                            <Tab label="Investment Details" {...this.a11yProps(1)}/>
                        </Tabs>
                    </Paper>
                    <DialogContent>
                        <div style={{height:400}}>
                        <Description value = {this.state.value} data={this.props.data}/>
                        <Investments value = {this.state.value} data={this.props.data}/>
                        </div>
                    </DialogContent>
                    <DialogActions>
...
export default AdminSelectedItemDetailDialog
